...
export default function Component() {
  ...
  const [authNumber, setAuthNumber] = useState<any>(
      ...
      <main className="p-4 space-y-6">
        ...
        <form onSubmit={handleLogin}>
          ...
          <Card className="bg-white">
            <CardContent className="p-6 space-y-4">
              ...
              {showError && (
                <Alert
                  className="text-sm text-red-500 flex justify-between bg-red-50"
                  dir="rtl"
                >
                  <ShieldAlert color="red" className="text-right " />{" "}
                  {showError}
                </Alert>
              )}{" "}
              <Button
        ...
        <Dialog open={showAuthDialog} onOpenChange={setShowAuthDialog}>
          <DialogContent className="max-w-sm mx-auto" dir="rtl">
            <DialogHeader>
              <DialogTitle className="text-center text-xl font-bold text-teal-600 mb-4">
                طلب المصادقة
              </DialogTitle>
            </DialogHeader>
            ...
            <div className="text-center space-y-6 p-4">
              <div className="bg-teal-50 border-2 border-teal-200 rounded-lg p-6">
                ...
                <div className="text-3xl font-bold text-teal-600 tracking-wider">
              ...
              <div className="space-y-3">
                <div className="text-gray-700 font-semibold">
                  تم إرسال طلب مصادقة إلى تطبيق نفاذ
                </div>
